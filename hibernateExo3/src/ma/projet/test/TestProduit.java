...
//        ps.create(new Produit("produit3", 400, cs.getById(1)));
//        ps.create(new Produit("produit4", 500, cs.getById(2)));
        
        for(Produit p : ps.findBetweenDate(new Date("2021/01/01"), new Date("2024/01/01"))){
